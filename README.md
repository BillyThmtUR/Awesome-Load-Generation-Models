...
| 2025 (month unverified) | **PV/EV building cGAN** — Conditional generative adversarial network (cGAN) for generating building load profiles with photovoltaics and electric vehicles<br><sub>Direct; Energy and Buildings 2025</sub> | cGAN | Bâtiments PV/EV | à vérifier; à vérifier | [Paper](https://doi.org/10.1016/j.enbuild.2025.115584) |
